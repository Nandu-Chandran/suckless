...
static Key keys[] = {
	...
	{ MODKEY,			XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#' ~/personal/bookmarks.txt | dmenu -i -l 50 | cut -d' ' -f1)") },
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer set Master 2%+; kill -44 $(pidof dwmblocks)") },
